 ...
 * Tejkumar PAnchal
 * This programe will print the whole calender between 1800 to 3000
 */
	...
	public static void main(String[] args) {
		...
		boolean repeat;
			do
			{
				...
				kb.nextLine();
				// This will ask the user to entre the option
				System.out.println("Select one of the following options:");
				// The options are year or month of that year and it will print according to their input
