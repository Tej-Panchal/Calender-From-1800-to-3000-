 ...
 * kb The Scanner object to read from System.in
 * prompt The prompt for the user
 * min The smallest value that the number can be.
 * max The largest value that the number can be.
 ...
 * startDay The day of the week that November starts on (0 = Sunday)
 ...
 *  on a Wednesday (3). With total number of days since 1/1/1800 we can add 3and then mod by 7 to get
 ...
 * year The year for the month to determine
 * month The month to determine
